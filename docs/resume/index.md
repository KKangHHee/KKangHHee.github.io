# 신강희 | 백엔드 개발자 (Shin Kang-hee)

> **"프론트엔드 최적화 경험을 바탕으로, 시스템 전체의 병목을 해결하는 백엔드 개발자입니다."** > 실사용 서비스 운영을 통해 데이터 정합성의 중요성을 체감하고 백엔드로 전향하였습니다.
...
- **핵심 기술:** - Spring Event + `@Async` 비동기 구조로 메일 발송 로직 분리
