...
| **팀 구성** | BE 2명, FE 4명, PM 1명, Designer 1명, Marketer 1명 |
| **역할**    | Frontend Developer                                 |
| **기여도**  | 17% (결제 시스템 / 매장 관리 화면 담당)            |
| **배포**    | AWS EC2 + NginX                                    |
...
>
  <div>![ERD_Customer](./img/erd_customer.png) - Customer ERD</div>
  <div>![ERD](./img/erd.png) - Owner ERD</div>
</div>
...
**문제**: Toss Payments Widget 초기화 시 3초 소요, 쿠폰/포인트 적용 시 화면 깜빡임
...
**문제**: Toss SDK 초기화에 3초 소요, useEffect 중복 실행
